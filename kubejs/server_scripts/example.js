...
//event.remove({id: 'minecraft:glowstone'}) // Removes recipe by ID. in this case, data/minecraft/recipes/glowstone.json
	...
	event.remove({output: 'coinsje:copper_coin'})
	event.remove({output: 'coinsje:copper_coin_pile'})
	event.remove({output: 'coinsje:iron_coin'})
	event.remove({output: 'coinsje:iron_coin_pile'})
	event.remove({output: 'coinsje:gold_coin'})
	event.remove({output: 'coinsje:gold_coin_pile'})
	event.remove({output: 'coinsje:diamond_coin'})
	event.remove({output: 'coinsje:diamond_coin_pile'})
	event.remove({output: 'coinsje:netherite_coin'})
	event.remove({output: 'coinsje:netherite_coin_pile'})
